...
public class CodesysBanner extends AbstractGetBanner{

    @Override
    public String getbanner(String ip, String port) {
        String output_file=this.output_file+port+"Banner.txt";
        String script_path=this.script_path+"Codesys.py";
        String result="";
        try{
    ...
    public static void main(String[] args){
        CodesysBanner test=new CodesysBanner();
        test.getbanner("112.161.227.166","2455");
    }
}
