...
public class EnipBanner extends AbstractGetBanner {//部分逻辑待定解决
    ...
    String[] vendors={
            ...
            "MKS Instruments (ENI Technology)",
            ...
            "HAEHNE Elektronische Messgerate GmbH",
            ...
            "ASI Advanced Semiconductor Instruments GmbH",
            "Datalogic Inc.",
            "SoftPLC Corporation",
            ...
            "DARCOM",
            "Frick Controls (div. of York International)",
            "SymCom Inc.",
            "Infranor",
            "Kyosan CableLtd.",
    ...
    Map<Integer,String> deviceType=new HashMap<Integer, String>(){{
        put(0,"Generic Device (deprecated)" );
        put(2,"AC Drive" );
        put(3,"Motor Overload" );
        put(4,"Limit Switch" );
        put(5,"Inductive Proximity Switch" );
        put(6,"Photoelectric Sensor" );
        put(7,"General Purpose Discrete I/O" );
        put(9,"Resolve" );
        put(12,"Communications Adapter" );
        put(14,"Programmable Logic Controller" );
        put(16,"Position Controller" );
        put(19,"DC Drive" );
        put(21,"Contactor" );
        put(22,"Motor Starter" );
        put(23,"Soft Start" );
        put(24,"Human-Machine Interface" );
        put(26,"Mass Flow Controller" );
        put(27,"Pneumatic Valve" );
        put(28,"Vacuum Pressure Gauge" );
        put(29,"Process Control Value" );
        put(30,"Residual Gas Analyzer" );
        put(31,"DC Power Generator" );
        put(32,"RF Power Generator" );
        put(33,"Turbomolecular Vacuum Pump" );
        put(34,"Encoder" );
        put(35,"Safety Discrete I/O Device" );
        put(36,"Fluid Flow Controller" );
        put(37,"CIP Motion Drive" );
        put(38,"CompoNet Repeater" );
        put(39,"Mass Flow Controller Enhanced" );
        put(40,"CIP Modbus Device" );
        put(41,"CIP Modbus Translator" );
        put(42,"Safety Analog I/O Device" );
        put(43,"Generic Device (keyable)" );
        put(44,"Managed Switch" );
        put(59,"ControlNet Physical Layer Component" );
    }
    };
    @Override
...
//        //String send_data="/gopath/src/github.com/zmap/zgrab/EnipData.txt";
//        String send_data="/home/ysf/go/src/github.com/zmap/zgrab/EnipData.txt";
        String send_data="/home/go/src/github.com/zmap/zgrab/EnipData.txt";
        String temp_cmd=this.cmd3+" --port 44818 "+
...
//            }
            ...
            for(int i=60;i<b.length;i++){
                if(b[i]>=65&&b[i]<=122||b[i]>=48&&b[i]<=57||b[i]==45||b[i]==47)
                    device.append((char) b[i]);
            ...
            String vendor="";
            String DeviceType="";
            for(;searchpos<=60;searchpos++){
                if(b[searchpos]!=0){
                    System.out.println(searchpos);
                    vendor=vendors[(int)b[searchpos]];
                    searchpos++;
                    break;
                }
            }
            for(;searchpos<=60;searchpos++){
                if(b[searchpos]!=0){
                    System.out.println(searchpos);
                    DeviceType=deviceType.get((int)b[searchpos]);
                    break;
                }
            }

//            String DeviceType=deviceType.get((int)b[56]);
            ip=ip+":44818";
            returnresult="{\"ip\":\""+ip+"\","+"\"DeviceType\":\""+DeviceType+"\","+"\"Vendor\":\""+vendor+"\","+"\"Device\":\""+device+"\","+
                    "\"Protocol\":\"Ethernet/IP\",\"Marked\":\"true\"}";
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    public static void main(String[] argv){
        GetBanner getBanner=GetBannerFactory.get("44818");
        getBanner.getbanner("192.168.1.20","44818");
    }
}
