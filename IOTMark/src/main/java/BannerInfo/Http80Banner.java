...
public class Http80Banner extends AbstractGetBanner {
    @Override
...
//                    System.out.println(www_authenticate);
                ...
                for(List<String> t:res){
                    if(t.size()==3){
                        ...
                        System.out.println("Vendor : "+t.get(0));
                        System.out.println("DeviceType : "+t.get(1));
                        System.out.println("Device : "+t.get(2));
                        break;
                    }
                }
            }
        ...
        if(markres.size()==3){
            ...
            if(connectInfo.equals("success")||connectInfo.equals("application-error"))
                ...
                raw=raw.replace("\\t","");
                raw=raw.replace("\\r","");
                jsonRes="{\"ip\":\""+ip+":80\","+"\"Protocol\":\"http\","+"\"Marked\":\"false\",\"raw\":\""+"\"}";
        }
        System.out.println(jsonRes+"\n\n");
        return jsonRes;
    }
    public static void main(String[] args){
        Http80Banner test=new Http80Banner();
        test.getbanner("192.168.0.1","80");
    }
}
