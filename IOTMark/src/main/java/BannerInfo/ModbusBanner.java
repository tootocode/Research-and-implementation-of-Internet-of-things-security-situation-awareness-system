...
public class ModbusBanner extends AbstractGetBanner{
    @Override
    public String getbanner(String ip, String port) {
        String output_file=this.output_file+port+"Banner.txt";
        String script_path=this.script_path+"Modbus.py";
        String result="";
        try{
    ...
    public static void main(String[] args){
        ModbusBanner test=new ModbusBanner();
        test.getbanner("192.168.1.19","502");
    }
}
