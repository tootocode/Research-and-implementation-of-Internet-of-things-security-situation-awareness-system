...
public class OmronBanner extends AbstractGetBanner {
    ...
    public static void main(String[] args){
        OmronBanner test=new OmronBanner();
        test.getbanner("74.198.207.75","9600");
    }
}
