...
public class OnvifBanner extends AbstractGetBanner {
    ...
    public static void main(String[] args){
        OnvifBanner test=new OnvifBanner();
        test.getbanner("170.253.2.222","3702");
    }
}
