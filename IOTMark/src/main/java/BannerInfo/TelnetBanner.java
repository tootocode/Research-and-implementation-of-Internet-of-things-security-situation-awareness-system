...
public class TelnetBanner extends AbstractGetBanner {
    @Override
    public String getbanner(String ip, String port) {
        ...
        String tempcmd=this.cmd+"--input-file="+input_file+" --output-file="+output_file+" -s 100 telnet";
        ...
        try{
            ...
            Raw= temp.get("data").toString();
            temp=(JSONObject) new JSONObject("{\"list\":"+temp.get("telnet")+"}").get("list");
            ...
            if(isSuccess.equals("success")||isSuccess.equals("application-error")){
                ...
                String raw=temp.getString("banner");
...
//                }
        ...
        if(markres.size()==3){
            ...
            jsonRes="{\"ip\":\""+ip+"\","+"\"Vendor\":\""+markres.get(0)+"\","+"\"DeviceType\":\""+markres.get(1)+"\","+
                    "\"Device\":\""+markres.get(2)+"\","+"\"Protocol\":\"telnet"+"\",\"Marked\":\"true\"}";
        }else{
            if(connectInfo.equals("success")||connectInfo.equals("application-error")){
                ip=ip+":23";
                jsonRes="{\"ip\":\""+ip+"\","+"\"Protocol\":\"telnet\","+"\"Marked\":\"false\",\"raw\":\""+Raw+"\"}";
            }
        }
        return jsonRes;
    }
